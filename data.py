class TestData:
    test_data_user1 = ['Иван', 'Петров', 'Проспект Мира 22', 'Университет', '+78881119999', '28.12.2024',
                 'Буду в красной куртке']

    test_data_user2 = ['Товарищ', 'Полковник', 'Проспект НКВД', 'Лубянка', '+78881119999', '28.12.2024',
                 'нужен самокат с мигалкой']
